...
function GLDG_OnEvent(self, event, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11)
	...
	elseif (event == "CHAT_MSG_CHANNEL_JOIN") then
		if (string.lower(arg9) == GLDG_ChannelName) then
...
function GLDG_Init()
	...
	getglobal("GuildGreetOptionsHeader"):SetText(GLDG_TXT.optionHeader)
...
function GLDG_InitFrame(frameName)
	...
	elseif (frameName == "Greetings") then
		...
		getglobal(name.."SelAchievment"):SetText(GLDG_TXT.achievment)
	elseif (frameName == "Players") then
		...
		getglobal(name.."GuildText"):SetText(GLDG_TXT.filterGuild)
		getglobal(name.."OnlineText"):SetText(GLDG_TXT.filterOnline)
		getglobal(name.."MyFriendsText"):SetText(GLDG_TXT.filterMyFriends)
		getglobal(name.."WithFriendsText"):SetText(GLDG_TXT.filterWithFriends)
		getglobal(name.."CurrentChannelText"):SetText(GLDG_TXT.filterCurrentChannel)
		getglobal(name.."WithChannelText"):SetText(GLDG_TXT.filterWithChannel)
		getglobal(name.."GuildSortText"):SetText(GLDG_TXT.guildSort)
		-- list header
		getglobal(name.."HeaderLineName"):SetText(GLDG_TXT.headerName)
		getglobal(name.."HeaderLineType"):SetText(GLDG_TXT.headerType)
		getglobal(name.."HeaderLineAlias"):SetText(GLDG_TXT.headerAlias)
		getglobal(name.."HeaderLineGuild"):SetText(GLDG_TXT.headerGuild)
		getglobal(name.."HeaderLineChannel"):SetText(GLDG_TXT.headerChannel)
		getglobal(name.."HeaderLineFriend"):SetText(GLDG_TXT.headerFriend)
		getglobal(name.."HeaderLineNumFriends"):SetText(GLDG_TXT.headerNumFriends)
		-- Button text
		getglobal(name.."ActionButtonsCheck"):SetText(GLDG_TXT.pbcheck)
		getglobal(name.."ActionButtonsAlias"):SetText(GLDG_TXT.pbalias)
		getglobal(name.."ActionButtonsGuild"):SetText(GLDG_TXT.pbguild)
		getglobal(name.."ActionButtonsWho"):SetText(GLDG_TXT.pbwho)
		getglobal(name.."ActionButtonsRemove"):SetText(GLDG_TXT.pbremove)
		getglobal(name.."ActionButtonsNote"):SetText(GLDG_TXT.pbnote)
		-- Set value for option checkboxes
		GLDG_UpdatePlayerCheckboxes()
	elseif (frameName == "Cleanup") then
		-- Header and option texts
		getglobal(name.."Header"):SetText(GLDG_TXT.cleanupHeader)
		getglobal(name.."Info"):SetText(GLDG_TXT.cleanupInfo)
		getglobal(name.."GuildHeader"):SetText(GLDG_TXT.cleanupGuildHeader)
		getglobal(name.."GuildInfo"):SetText(GLDG_TXT.cleanupGuildInfo)
		getglobal(name.."FriendsHeader"):SetText(GLDG_TXT.cleanupFriendsHeader)
		getglobal(name.."FriendsInfo"):SetText(GLDG_TXT.cleanupFriendsInfo)
		getglobal(name.."ChannelHeader"):SetText(GLDG_TXT.cleanupChannelHeader)
		getglobal(name.."ChannelInfo"):SetText(GLDG_TXT.cleanupChannelInfo)
		getglobal(name.."OrphanHeader"):SetText(GLDG_TXT.cleanupOrphanHeader)
		getglobal(name.."OrphanInfo"):SetText(GLDG_TXT.cleanupOrphanInfo)

		getglobal(name.."Guild"):SetText(GLDG_TXT.cleanupGuild)
		getglobal(name.."Friends"):SetText(GLDG_TXT.cleanupFriends)
		getglobal(name.."Channel"):SetText(GLDG_TXT.cleanupChannel)
		getglobal(name.."Orphan"):SetText(GLDG_TXT.cleanupOrphan)
	elseif (frameName == "Colour") then
		...
		getglobal(name.."Achievment"):SetText(GLDG_TXT.colAchievment)
		...
		getglobal(name.."FriendsAchievmentButton"):Hide()
		getglobal(name.."FriendsAchievmentColour"):Hide()
		...
		getglobal(name.."ChannelAchievmentButton"):Hide()
		getglobal(name.."ChannelAchievmentColour"):Hide()
	elseif (frameName == "Todo") then
		getglobal(name.."TodoText"):SetText(GLDG_TXT.infoTodo)
		getglobal(name.."HistoryText"):SetText(GLDG_TXT.infoHistory)
		getglobal(name.."HelpText"):SetText(GLDG_TXT.infoHelp)
	...
	elseif (frameName == "SettingsChat") then
		...
		getglobal(name.."AddPostfixText"):SetText(GLDG_TXT.addPostfix)
		getglobal(name.."AddPostfixBox"):SetChecked(GLDG_Data.AddPostfix)
		getglobal(name.."ShowWhoSpamText"):SetText(GLDG_TXT.showWhoSpam)
		getglobal(name.."ShowWhoSpamBox"):SetChecked(GLDG_Data.ShowWhoSpam)
		getglobal(name.."ListAchievmentsText"):SetText(GLDG_TXT.listAchievments)
		getglobal(name.."ListAchievmentsBox"):SetChecked(GLDG_Data.ListAchievments)
	elseif (frameName == "SettingsGreeting") then
		...
		getglobal(name.."SupressAchievmentText"):SetText(GLDG_TXT.supressAchievment)
	...
	elseif (frameName == "SettingsOther") then
		...
		getglobal(name.."AutoWhoText"):SetText(GLDG_TXT.autoWho)
		getglobal(name.."AutoWhoBox"):SetChecked(GLDG_Data.AutoWho)
		getglobal(name.."DeltaPopupText"):SetText(GLDG_TXT.deltaPopup)
		getglobal(name.."DeltaPopupBox"):SetChecked(GLDG_Data.DeltaPopup)
...
function GLDG_UpdateTodoCheckboxes()
	...
	if (GLDG_Data.InfoMode and GLDG_Data.InfoMode=="todo") then
		getglobal(name.."TodoBox"):SetChecked(true)
		getglobal(name.."HistoryBox"):SetChecked(false)
		getglobal(name.."HelpBox"):SetChecked(false)
	elseif (GLDG_Data.InfoMode and GLDG_Data.InfoMode=="history") then
		getglobal(name.."TodoBox"):SetChecked(false)
		getglobal(name.."HistoryBox"):SetChecked(true)
		getglobal(name.."HelpBox"):SetChecked(false)
	else
		getglobal(name.."TodoBox"):SetChecked(false)
		getglobal(name.."HistoryBox"):SetChecked(false)
		getglobal(name.."HelpBox"):SetChecked(true)
	end
end
...
function GLDG_UpdatePlayerCheckboxes()
	...
	getglobal(name.."GuildBox"):SetChecked(GLDG_Data.FilterGuild)
	getglobal(name.."OnlineBox"):SetChecked(GLDG_Data.FilterOnline)
	getglobal(name.."MyFriendsBox"):SetChecked(GLDG_Data.FilterMyFriends)
	getglobal(name.."WithFriendsBox"):SetChecked(GLDG_Data.FilterWithFriends)
	getglobal(name.."CurrentChannelBox"):SetChecked(GLDG_Data.FilterCurrentChannel)
	getglobal(name.."WithChannelBox"):SetChecked(GLDG_Data.FilterWithChannel)
	getglobal(name.."GuildSortBox"):SetChecked(GLDG_Data.GuildSort)

	if (GLDG_Data.FilterOnline or GLDG_Data.GuildSort) then
		getglobal(name.."Alt2Box"):Disable()
	else
		getglobal(name.."Alt2Box"):Enable()
	end
end
...
function GLDG_ShowQueue()
	...
	for cnt = 1, math.min(total, GLDG_Data.ListSize) do
		...
		getglobal(line.."Text2"):SetText(postfix)
		if (GLDG_DataChar[queue[cnt]]) then
			if GLDG_DataChar[queue[cnt]].new then
				colorName = "new"
				getglobal(line.."Text2"):SetText(GLDG_TXT.new..postfix)
			elseif GLDG_DataChar[queue[cnt]].newlvl then
				colorName = "lvl"
				getglobal(line.."Text2"):SetText(GLDG_TXT.lvl..postfix)
			elseif GLDG_DataChar[queue[cnt]].newrank then
				colorName = "rank"
				getglobal(line.."Text2"):SetText(GLDG_TXT.rank..postfix)
			elseif GLDG_DataChar[queue[cnt]].achievment then
				colorName = "achievment"
				getglobal(line.."Text2"):SetText(GLDG_TXT.achv..postfix)
...
function GLDG_ShowToolTip(buttonName)
	...
	if GLDG_DataChar[name] then
		...
		local oname = name
		if GLDG_DataChar[name].alias then
			name = name.." ("..GLDG_DataChar[name].alias..")"
		end
...
function GLDG_ParseCustomMessage(cname, name, msg)
	...
	if (player.storedLvl) then
		p_L = tostring(80 - player.storedLvl)
	elseif (player.lvl) then
		p_L = tostring(80 - player.lvl)
	end
...
function GLDG_ClickSubTab(self, tabName)
	-- Actions to perform when a tab is clicked
	PanelTemplates_Tab_OnClick(self, getglobal(GLDG_GUI.."Settings"))
	-- Show frame linked to tab, hide all others
	local tabNum = 1
...
function GLDG_UpdateSupressed()
	...
	getglobal(name.."SupressAchievmentBox"):SetChecked(GLDG_Data.SupressAchievment)
end
...
function GLDG_ClickGreetButton(id)
	...
	if (GLDG_Selection == "Achievment") then getglobal(frame.."SelAchievment"):Disable() else getglobal(frame.."SelAchievment"):Enable() end
...
function GLDG_GuildFilterDropDown_Initialize(frame, level)
	...
	GLDG_Print("Frame ["..tostring(frame).."] - level ["..tostring(level).."]")
	...
	for q in pairs(GLDG_guildFilterDropDownData) do
		...
		UIDropDownMenu_AddButton(info, level)
		if (GLDG_Data.GuildFilter and GLDG_guildFilterDropDownData[q] == GLDG_Data.GuildFilter) then
			UIDropDownMenu_SetSelectedID(getglobal(GLDG_GUI.."Players".."GuildFilterDropboxButton"), q);
	...
	if not found then
		UIDropDownMenu_SetSelectedID(getglobal(GLDG_GUI.."Players".."GuildFilterDropboxButton"), 1);
	end
end

------------------------------------------------------------
function GLDG_GuildFilterDropDown_OnClick(list)

	if not GLDG_guildFilterDropDownData then GLDG_guildFilterDropDownData = {} end
	local i = this:GetID();
	local n = this:GetParent():GetID()
	...
	if (GLDG_Data.GuildFilter == "") then
		...
		UIDropDownMenu_SetSelectedID(getglobal(GLDG_GUI.."Players".."GuildFilterDropboxButton"), i);
	end
...
function GLDG_ShowPlayers()
	...
	while GLDG_SortedList[cnt + GLDG_PlayerOffset] and getglobal(line..cnt) do
		local textName = getglobal(line..cnt.."Name")
		local textType = getglobal(line..cnt.."Type")
		local textAlias = getglobal(line..cnt.."Alias")
		local textMain = getglobal(line..cnt.."Main")
		local textGuild = getglobal(line..cnt.."Guild")
		local textChannel = getglobal(line..cnt.."Channel")
		local textFriend = getglobal(line..cnt.."Friend")
		local textNumFriends = getglobal(line..cnt.."NumFriends")
	...
	for cnt2 = cnt, GLDG_NumPlrRows do
		getglobal(line..cnt2.."Name"):SetText("")
		getglobal(line..cnt2.."Type"):SetText("")
		getglobal(line..cnt2.."Alias"):SetText("")
		getglobal(line..cnt2.."Main"):SetText("")
		getglobal(line..cnt2.."Guild"):SetText("")
		getglobal(line..cnt2.."Channel"):SetText("")
		getglobal(line..cnt2.."Friend"):SetText("")
		getglobal(line..cnt2.."NumFriends"):SetText("")
		getglobal(line..cnt2):Disable()
	end
	-- Set/clear highlight
	for cnt = 1, GLDG_NumPlrRows do
		if GLDG_SelPlrName and (GLDG_SortedList[cnt + GLDG_PlayerOffset] == GLDG_SelPlrName) then
			getglobal(line..cnt):LockHighlight()
		else
			getglobal(line..cnt):UnlockHighlight()
		end
	end
	-- Update buttons
...
function GLDG_ShowPlayerToolTip(element)
	...
	local name = getglobal(element.."Name"):GetText()
	...
	if (name and GLDG_DataChar[name]) then
		...
		GameTooltip:SetOwner(getglobal(element), "ANCHOR_CURSOR")
...
function GLDG_ShowPlayerButtons()
	...
	getglobal(frame.."SubGuild"):Hide()
	getglobal(frame.."SubNote"):Hide()
	...
	if not GLDG_SelPlrName then
		...
		getglobal(frame.."Check"):Show()
		getglobal(frame.."Ignore"):Hide()
		getglobal(frame.."Alias"):Hide()
		getglobal(frame.."Main"):Hide()
		getglobal(frame.."Alt"):Hide()
		getglobal(frame.."Guild"):Hide()
		getglobal(frame.."Who"):Hide()
		getglobal(frame.."Remove"):Hide()
		getglobal(frame.."Note"):Hide()
		return
	end
	-- show subframe
	getglobal(frame):Show()
	...
	-- Note button
	button = getglobal(frame.."Note")
	button:Show()
	button:Enable()
	-- Who button
	button = getglobal(frame.."Who")
	button:Show()
...
function GLDG_ClickAlias()
	...
	GLDG_ShowPlayerButtons()
	this:Disable()
	getglobal(this:GetParent():GetParent():GetParent():GetName().."SubAlias"):Show()
end
...
function GLDG_ShowPlayerAlias(frame)
	...
	if p.alias then
		...
		getglobal(frame.."Set"):SetText(GLDG_TXT.set)
...
function GLDG_ClickAlt()
	...
	elseif (GLDG_NumMain == 1) then
		...
		this:Disable()
		getglobal(this:GetParent():GetParent():GetParent():GetName().."SubMainAlt"):Show()
		return
	end
	-- Show updated list
	GLDG_ListPlayers()
...
------------------------------------------------------------
function GLDG_ClickGuild()
	-- Activate guild subframe
	GLDG_ShowPlayerButtons()
	this:Disable()
	getglobal(this:GetParent():GetParent():GetParent():GetName().."SubGuild"):Show()
end

------------------------------------------------------------
function GLDG_ShowPlayerGuild(frame)
	-- Set title
	getglobal(frame.."Header"):SetText(string.format(GLDG_TXT.guildhead, GLDG_SelPlrName))
	-- Set editbox and buttons text
	local p = GLDG_DataChar[GLDG_SelPlrName]
	if p.guild then
		getglobal(frame.."Set"):SetText(GLDG_TXT.update)
		getglobal(frame.."Del"):SetText(GLDG_TXT.delete)
		getglobal(frame.."Editbox"):SetText(p.guild)
	else
		getglobal(frame.."Set"):SetText(GLDG_TXT.set)
		getglobal(frame.."Del"):SetText(GLDG_TXT.cancel)
		getglobal(frame.."Editbox"):SetText("") end
...
------------------------------------------------------------
function GLDG_ClickNote()
	-- Activate note subframe
	GLDG_ShowPlayerButtons()
	this:Disable()
	getglobal(this:GetParent():GetParent():GetParent():GetName().."SubNote"):Show()
end
...
function GLDG_ShowPlayerNote(frame)
	-- Set title
	getglobal(frame.."Header"):SetText(string.format(GLDG_TXT.notehead, GLDG_SelPlrName))
	-- Set editbox and buttons text
	local p = GLDG_DataChar[GLDG_SelPlrName]
	if p.note then
		getglobal(frame.."Set"):SetText(GLDG_TXT.update)
		getglobal(frame.."Del"):SetText(GLDG_TXT.delete)
		getglobal(frame.."Editbox"):SetText(p.note)
	else
		getglobal(frame.."Set"):SetText(GLDG_TXT.set)
		getglobal(frame.."Del"):SetText(GLDG_TXT.cancel)
		getglobal(frame.."Editbox"):SetText("") end
	...
	if (achievment) then
		...
		if (main) then
			if (GLDG_Data.ListAchievments) then
				GLDG_Print(arg2..GLDG_Data.colours.help.." {"..main.."}|r "..GLDG_TXT.achieved.." "..tostring(achievment))
			end
		end
...
--[[
	...
	if GLDG_Data.ExtendChat then
		...
		if (event) then
			...
			if (((event == "CHAT_MSG_GUILD") and arg2) or
				...
				treated = true
				if (GLDG_DataChar[arg2] and not GLDG_DataChar[arg2].ignore) then
	...
	return false, msg, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12;
end
...
function GLDG_CleanupShowTab()
	-- Hide the subframe window
	getglobal(GLDG_GUI.."CleanupSubEntries"):Hide()

	-- re-enable buttons
	getglobal(GLDG_GUI.."CleanupGuild"):Enable()
	getglobal(GLDG_GUI.."CleanupFriends"):Enable()
	getglobal(GLDG_GUI.."CleanupChannel"):Enable()
end

function GLDG_ClickCleanup(mode)
	...
	this:Disable()
	getglobal(this:GetParent():GetName().."SubEntries"):Hide()	-- do this to refresh an already displayed list
	getglobal(this:GetParent():GetName().."SubEntries"):Show()
end
...
function GLDG_ShowCleanupEntries(frame)
	...
	if (GLDG_TableSize(GLDG_CleanupList) > 0) then
		if GLDG_CleanupMode == "guild" then
			getglobal(name.."Header"):SetText(GLDG_TXT.cleanupHeaderEntryGuild)
		elseif GLDG_CleanupMode == "friends" then
			getglobal(name.."Header"):SetText(GLDG_TXT.cleanupHeaderEntryFriends)
		elseif GLDG_CleanupMode == "channel" then
			getglobal(name.."Header"):SetText(GLDG_TXT.cleanupHeaderEntryChannel)
		else
			getglobal(name.."Header"):SetText("")
		end
	else
		if GLDG_CleanupMode == "guild" then
			getglobal(name.."Header"):SetText(GLDG_TXT.cleanupHeaderNoEntryGuild)
		elseif GLDG_CleanupMode == "friends" then
			getglobal(name.."Header"):SetText(GLDG_TXT.cleanupHeaderNoEntryFriends)
		elseif GLDG_CleanupMode == "channel" then
			getglobal(name.."Header"):SetText(GLDG_TXT.cleanupHeaderNoEntryChannel)
		else
			getglobal(name.."Header"):SetText("")
		end
		getglobal(GLDG_GUI.."CleanupGuild"):Enable()
	...
	for line = 1, GLDG_NumSubRows do
		if GLDG_CleanupList[line + offset] then
			getglobal(name..line.."Text"):SetText(GLDG_CleanupList[line + offset])
			getglobal(name..line):Enable()
		else	getglobal(name..line.."Text"):SetText("")
			getglobal(name..line):Disable()
		end
	end
end

------------------------------------------------------------
function GLDG_ClickCleanupEntry(entry)
	-- todo: confirm dialog
