...
GLDG_TXT.addPostfix	= "Show source of character info in curly braces when printing names to chat"
GLDG_TXT.showWhoSpam	= "Show /who request and response text in chat"
GLDG_TXT.listAchievments = "Show achievments of guild members with main/alt in chat"
...
GLDG_TXT.supressAchievment = "Don't put players that get achievments on the greet list"
...
GLDG_TXT.autoWho	= "Automatically start /who request when channel member with lacking info logs on"
GLDG_TXT.deltaPopup	= "Show popup box summarising offline changes at login"
...
GLDG_TXT.achievment	= "achievment"
...
GLDG_TXT.Achievment	= "Edit achievment congratulations: first %s is player, second %s is achievment"
