...
GLDG_TXT.useFriends	= "Freunde-Liste auch verwalten"
GLDG_TXT.autoAssign	= "Automatische Alt/Main Zuteilung aufgrund der Gildennotiz"
GLDG_TXT.channelName	= "Zu verfolgender Channel-Name"
GLDG_TXT.includeOwn	= "Zeige eigene Charaktere an"
GLDG_TXT.minlevelupalways = "Level-up immer anzeigen"
GLDG_TXT.minlevelup	= "Zeige Level-up nur für Level höher als %d"
GLDG_TXT.eventonly	= "Gildenliste nur bei Ereignis prüfen"
GLDG_TXT.updatetime	= "Gildenliste alle %d Sekunden prüfen"
GLDG_TXT.none		= "<Kein Channel>"

-- Settings tab: chat options
GLDG_TXT.chatheader	= "Zeige Informationen im Chat an"
GLDG_TXT.defaultChatFrame = "Default Chat Fenster verwenden"
GLDG_TXT.chatFrame	= "Verwende Chat Fenster %d (%s)"
GLDG_TXT.listNames	= "Alle Spielernamen auflisten beim Einloggen"
GLDG_TXT.listNamesOff	= "Alle Spielernamen auflisten beim Ausloggen"
GLDG_TXT.listLevelUp	= "Im Chat anzeigen, wenn ein Spieler einen neuen Level erreicht hat (online)"
GLDG_TXT.listLevelUpOff	= "Im Chat anzeigen, wenn ein Spieler einen neuen Level erreicht hat (offline, wird beim Einloggen angezeigt)"
GLDG_TXT.listQuit	= "Im Chat anzeigen, wenn ein Spieler die Gilde verlässt"
GLDG_TXT.extendChat	= "Im Chat den Namen des Mains vor Nachrichten eines Twinks stellen"
GLDG_TXT.extendMain	= "Im Chat den Namen des Mains sogar für den Main nochmals anfügen (falls obige Option aktiviert ist)"
GLDG_TXT.extendAlias	= "Im Chat das Alias anstelle des Namens des Mains vor Nachrichten eines Twinks stellen (falls obige Option aktiviert ist)"
GLDG_TXT.addPostfix	= "Quelle in geschweiften Klammern im Chat hinter Namen anzeigen"
GLDG_TXT.showWhoSpam	= "Zeige /who Anfragen und Antworten im Chat"
GLDG_TXT.listAchievments  = "Im Chat Erfolge von Gildenmitgliedern mit Main/Twink anzeigen"

-- Settings tab: greeting options
GLDG_TXT.greetingheader	= "Gilde und Channel grüssen (Einstellung pro Charakter)"
GLDG_TXT.greetGuild	= "Gilde begrüssen, wenn 'Greet Key' gedrückt wird (gilt auch beim Verabschieden)"
GLDG_TXT.greetChannel	= "Channel begrüssen, wenn 'Greet Key' gedrückt wird (gilt auch beim Verabschieden)"
GLDG_TXT.autoGreet	= "Automatisch beim Einloggen Gilde und Channel begrüssen (je nach Einstellung oben) |cFFFF0000Vorsichtig benutzen (vgl. Tooltip)."
GLDG_TXT.greetingsubheader = "Vorübergehend Charaktere nicht grüssen"
GLDG_TXT.supressAll	= "Alle unterdrücken"
GLDG_TXT.supressNone	= "Alle zulassen"
GLDG_TXT.supressGreet	= "Charaktere, die einloggen nicht in Grussliste setzen"
GLDG_TXT.supressJoin	= "Charaktere, die der Gilde beitreten nicht in Grussliste setzen"
GLDG_TXT.supressLevel	= "Charaktere, die einen neuen Level erreichen nicht in Grussliste setzen"
GLDG_TXT.supressRank	= "Charaktere, die befördert werden nicht in Grussliste setzen"
GLDG_TXT.supressAchievment = "Charaktere, die einen Erfolg erreichen nicht in Grussliste setzen"
GLDG_TXT.npGratsOnLogin	= "Beim Einloggen nicht gratulieren"
GLDG_TXT.guildAlias	= "Gilden-Alias für: "
GLDG_TXT.guildNoAlias	= "Kann kein Gilden-Alias setzen, ohne in Gilde zu sein"

-- Settings tab: Debug
GLDG_TXT.dumpHeader	= "GuildGreetDump Schnittstelle"
GLDG_TXT.noDumping	= "GuildGreetDump nicht gefunden - kann Dumping nicht aktivieren"
GLDG_TXT.noDumpingShort	= "GuildGreetDump nicht gefunden"
GLDG_TXT.enableDump	= "Dumping von Debug Informationen mit GuildGreetDump aktivieren"
GLDG_TXT.verboseDump	= "Sammle Debug Information im 'gesprächigen' Modus"
GLDG_TXT.dumpSet	= "Es sind %d Dump Sets in der SavedVariables Datei gespeichert"
GLDG_TXT.currentIndex	= "Es sind %d Einträge im Dump Set %d gespeichert"
GLDG_TXT.btnClear	= "Aktuelles Set (Set %d) löschen"
GLDG_TXT.btnClearAll	= "Alle Sets löschen"
GLDG_TXT.btnNew		= "Neues Set verwenden"

-- Settings tab: other options
GLDG_TXT.otherheader	= "Verschieden Einstellungen"
GLDG_TXT.useLocalTime	= "Lokalzeit statt Serverzeit verwenden"
GLDG_TXT.showNewerVersions = "Anzeigen, wenn neuere Versionen des Addons verfügbar sind"
GLDG_TXT.enableContextMenu = "Kontextmenu für Spieler aktivieren (kann zu Taint Problemem mit dem Raidframe führen, siehe Tooltip)"
GLDG_TXT.autoWho	= "Automatisch eine /who Anfrage starten, wenn ein Channel-Mitglied einloggt, für das Information fehlt"
GLDG_TXT.deltaPopup	= "Zeige Popup-Liste aller Offline-Änderung beim Einloggen"
...
GLDG_TXT.bye		= "Tschüss Spieler"
GLDG_TXT.night		= "Nacht Spieler"
GLDG_TXT.guild		= "Guild grüssen"
GLDG_TXT.channel	= "Channel grüssen"
GLDG_TXT.byeGuild	= "Tschüss Gilde"
GLDG_TXT.nightGuild	= "Tschüss Channel"
GLDG_TXT.byeChannel	= "Nacht Gilde"
GLDG_TXT.nightChannel	= "Nacht Channel"
GLDG_TXT.laterGuild	= "Später Gilde"
GLDG_TXT.laterChannel	= "Später Channel"
GLDG_TXT.achievment	= "Erfolg"
...
GLDG_TXT.Night		= "Speilerabschied (Nacht) editieren: erste Verwendung %s wird zum Spielernamen"
GLDG_TXT.Guild		= "Gruss der Gilde editieren: erste Verwendung %s wird zum Gildenalias"
GLDG_TXT.Channel	= "Gruss des Channels editieren: erste Verwendung %s wird zum Gildenalias"
GLDG_TXT.ByeGuild	= "Gildenabschied (Tag) editieren: erste Verwendung %s wird zum Gildenalias"
GLDG_TXT.NightGuild	= "Gildenabschied (Nacht) editieren: erste Verwendung %s wird zum Gildenalias"
GLDG_TXT.ByeChannel	= "Channelabschied (Tag) editieren"
GLDG_TXT.NightChannel	= "Channelabschied (Nacht) editieren"
GLDG_TXT.LaterGuild	= "Bis später Gilde editieren: erste Verwendung %s wird zum Gildenalias"
GLDG_TXT.LaterChannel	= "Bis später Channel editieren"
GLDG_TXT.Achievment	= "Gratulation zu Erfolgen editieren: erstes %s Spieler, zweites %s Erfolg"
...
GLDG_TXT.elements.tip.SettingsGeneralChannelNameDropboxButton	= "Falls Du einen anderne Channel als "..GLDG_TXT.none.." auswählst, so überwacht GuildGreet Charaktere, die dem Channel beitreten und ihn verlassen."
...
GLDG_TXT.elements.tip.PlayersActionButtonsNote		= "Verwender diesen Knopf, um dem aktuell ausgewählten Charakter eine eigene Notiz hinzuzufügen/zu editieren/zu löschen. Diese Notiz wird im Tooltip des Charakters angezeigt.\r\nDiese Notiz ist unabhängig von der Gildennotiz, der Offiziersnotiz und der Freunde-Notiz, welche separat im Tooltip angezeigt werden."
