...
function B:ContructContainerFrame(name, isBank)
	...
	if isBank then
		...
		f.bagsButton:SetScript("OnClick", function() ToggleFrame(f.ContainerHolder) end)
               ...
               f.transmogButton.ttText = "Transmog Collector"
               if _G.TransmogCollectorMiniMapButton then
                       f.transmogButton:SetScript("OnEnter", _G.TransmogCollectorMiniMapButton:GetScript("OnEnter"))
                       f.transmogButton:SetScript("OnLeave", _G.TransmogCollectorMiniMapButton:GetScript("OnLeave"))
                       f.transmogButton:SetScript("OnClick", _G.TransmogCollectorMiniMapButton:GetScript("OnClick"))
               else
